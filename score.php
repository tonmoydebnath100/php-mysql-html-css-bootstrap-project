...
<body>
  <div class="navbar">
    ...
    $round=array("Round of 16","Quarter-final","Semi-final","Play-off for third place","Final");
    ...
    <?php
    $sql = "select * from match_schedule WHERE (round= '$value')";
    ...
    ?>
      <div class="col-lg-4 col-md-6 col-sm-12 my-5 ">
        <div class="card bg-light" style="width: 19rem; height:200px;">
