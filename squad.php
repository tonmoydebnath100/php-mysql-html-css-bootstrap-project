...
<body>
  <div class="navbar">
    ...
    $name = $_GET['name'];
    $s="select no_team from team WHERE (team_name='$name')";
    $r=mysqli_query($conn, $s);
    $ro = mysqli_fetch_row($r);
    $sql = "select * from squad where (no_team='$ro[0]')";
    $result = mysqli_query($conn, $sql);
    while($row = mysqli_fetch_row($result)){
    ?>
      <div class="col-lg-3 col-md-4 col-sm-6 my-5 ">
        <div class="card align-items-center bg-light" style="width: 200px; height:300px;">
          <div >
          <img src="<?php echo $row[2];?>" class="card-img-top"style="width: 150px; height:250px;" alt="...">
          
          
          <h6 class="mt-2"><?php echo $row[1];?></h6>
